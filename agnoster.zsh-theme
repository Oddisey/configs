...
# user@host
AGNOSTER_CONTEXT_FG='#AFAFAF'
AGNOSTER_CONTEXT_BG='#484848'
...
# Status symbols
AGNOSTER_STATUS_RETVAL_FG='#B96A63'
...
prompt_git_relative() {
  ...
  if [[ $path_in_repo != '' ]]; then
    prompt_segment $AGNOSTER_GIT_DIRTY_BG $AGNOSTER_GIT_DIRTY_FG "$path_in_repo"
  fi;
}
